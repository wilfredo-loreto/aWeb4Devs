...
function PrivacyPolicyContent() {
  return (
    <div className={styles.mainContainer}>
      ...
      <p className={styles.text}>Thank you for choosing to be part of our community at aWeb4Devs (“Company”, “we”, “us”, or “our”). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at contact@aweb4devs.com.<br/>
      ...
      <b>Please read this privacy notice carefully as it will help you understand what we do with the information that we collect.</b> </p>
      <h4>TABLE OF CONTENTS</h4>
      <ol className={styles.orderedList}>
          <li className={styles.listItem}>WHAT INFORMATION DO WE COLLECT?</li>
          <li className={styles.listItem}>HOW DO WE USE YOUR INFORMATION?</li>
          <li className={styles.listItem}>WILL YOUR INFORMATION BE SHARED WITH ANYONE?</li>
          <li className={styles.listItem}>WHO WILL YOUT INFORMATION BE SHARED WITH?</li>
          <li className={styles.listItem}>DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</li>
          <li className={styles.listItem}>HOW LONG DO WE KEEP YOUR INFORMATION?</li>
      ...
      <h5 className={styles.subtitle}>1. WHAT INFORMATION DO WE COLLECT?</h5>
      <p className={styles.text}>Personal information you disclose to us <br/>
<i><b>In Short:</b>  We collect information that you provide to us.</i><br/>
...
Personal Information Provided by You. We collect names; email addresses; and other similar information.<br/>
All personal information that you provide to us must be true, complete and accurate, and you must notify us of any changes to such personal information.
 </p>
    <h6>Information automatically collected</h6>
      <p className={styles.text}><i>In Short:  Some information — such as your Internet Protocol (IP) address and/or browser and device characteristics — is collected automatically when you visit our Website.</i>
...
The information we collect includes:
 ...
 <h5 className={styles.subtitle}>2. HOW DO WE USE YOUR INFORMATION?</h5>
      <p className={styles.text}><i><b>In Short:</b>  We process your information for purposes based on legitimate business interests, the fulfillment of our contract with you, compliance with our legal obligations, and/or your consent.</i><br/>
 ...
 <h5 className={styles.subtitle}>3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h5>
      <p className={styles.text}><i> <b>In Short:</b>  We only share information with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfill business obligations.</i><br/>
We may process or share your data that we hold based on the following legal basis:<br/>
 ...
 <ul>
     ...
     <li><b>Vital Interests:</b> We may disclose your information where we believe it is necessary to investigate, prevent, or take action regarding potential violations of our policies, suspected fraud, situations involving potential threats to the safety of any person and illegal activities, or as evidence in litigation in which we are involved.</li>
      ...
      <p className={styles.text}>More specifically, we may need to process your data or share your personal information in the following situations: </p>
      <ul>
      ...
      <h5 className={styles.subtitle}>4. WHO WILL YOUR INFORMATION BE SHARED WITH?</h5>
      <p className={styles.text}><i><b>In Short:</b> We only share information with the following third parties.</i><br/>
      ...
      <ul>
          <li><b>Advertising, Direct Marketing, and Lead Generation</b> <br/> Google AdSense</li>
      </ul>
      </p>

      <h5 className={styles.subtitle}>5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h5>
      <p className={styles.text}>
           
      <i><b>In Short:</b> We may use cookies and other tracking technologies to collect and store your information.</i><br/>
      We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice.
      </p>
      <h5 className={styles.subtitle}>6. HOW LONG DO WE KEEP YOUR INFORMATION?</h5>
      <p className={styles.text}><i><b>In Short:</b> We keep your information for as long as necessary to fulfill the purposes outlined in this privacy notice unless otherwise required by law.</i><br/>
