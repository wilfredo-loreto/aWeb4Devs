...
function PrivacyPolicyContent() {
  return (
    <div className={styles.mainContainer}>
      ...
      <span className={styles.lastUpdate}>Last updated November 15, 2020</span>
      ...
      <ol className={styles.orderedList}>
        ...
        <li className={styles.listItem}>
          WHO WILL YOUT INFORMATION BE SHARED WITH?
        </li>
        <li className={styles.listItem}>
      ...
      <ul>
        ...
        <li>
          ...
          such as your IP address (or proxy server), device application
      ...
      <p className={styles.text}>
        <i>
          <b>In Short:</b> We only share information with the following third
          parties.
        </i>
        <br />
      ...
      <br />
      We may update this privacy notice from time to time. awebfordevs reserves
      the right to change, modify, add and / or remove some or more of the rules
      that are governed in these privacy policies at any time. We encourage you
      to review this privacy notice frequently to be informed of how we are
      ...
      <p className={styles.text}>
        ...
        contact@aweb4devs.com or by post to:
        <br />
        aWeb4Devs
        <br />
        Valencia, Urbanización La Isabelica, Sector 4, Pathway 1, House N° 29
        <br />
